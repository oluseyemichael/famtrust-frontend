...
const Created = ({ isOpen, onClose }) => {
  ...
  return (
    <div>
      <div className="bg-secondary-grey bg-opacity-0 fixed flex  justify-center items-center top-[0] bottom-0 right-0 left-0">
        <div className="py-[32px] px-2 text-center mx-auto w-3/6 bg-primary-white pt-4 border-2 border-secondary-grey3 rounded-xl text-base font-lato">
          ...
          <button onClick={() => isOpen(true)} className="px-4 py-1 border rounded-xl bg-primary-blue mt-6 text-white">
            <Link to=""></Link> ok
          </button>
        </div>
      </div>
